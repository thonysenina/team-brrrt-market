...
export default function AdminPanel() {
  ...
  const createEvent = async () => {
    ...
    setNewEventForm({ name: '', event_date: '', location: '', organizer_pin: '' });
  };

  const exportCSV = () => {
    const rows = [['Merchant', 'Shop Name', 'Status', 'Gross Revenue', 'Transactions']];
    merchantRevenues.forEach(m => {
      rows.push([m.full_name, m.shop_name, m.status, m.revenue.toFixed(2), m.txCount]);
    });
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }} className="animate-fade">
            ...
            <div className="card" style={{ padding: 0 }}>
              ...
              <div className="table-wrap">
                <table>
                  <thead><tr><th>Merchant</th><th>Shop</th><th>Gross Revenue</th><th>Txns</th><th>Status</th></tr></thead>
                  <tbody>
